	   ...
	   //this.load.atlas('arcade', 'assets/virtualjoystick/skins/arcade-joystick.png', 'assets/virtualjoystick/skins/arcade-joystick.json');
        ...
        game.load.image('corona', 'assets/small.png');
         game.load.image('bullet', 'assets/bb.png');
          ...
          game.load.image('health','assets/bar1.jpg');
          game.load.image('sheild','assets/bar2.jpg');
},
...
create: function(){
    ...
    sheild=game.add.sprite(game.world.centerX, game.world.centerY,'health');
    ...
    // game.physics.arcade.overlap(weapon2, sprite, enemyHitsPlayer, null, this);
  ...
  // sheild.trackSprite(sprite, 0, 0, true);
...
update: function(){
 ...
 game.world.wrap(sprite, 0, true);
  weapon2.fire();
//3 weapon2.bullet.kill();
 
 
  //game.physics.arcade.overlap(sprite, weapon2, checkOverlap, null, this);
 this.physics.arcade.collide(weapon2.bullets,sprite,checkOverlap, null, this);
 
},
render: function() {

    game.debug.cameraInfo(game.camera, 500, 32);
    game.debug.spriteCoords(sprite, 31, 32);
